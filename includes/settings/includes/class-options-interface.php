...
class wdxxx_Options_Framework_Interface {

	/**
	 * Generates the tabs that are used in the options menu
	 */
	static function wdxxx_optionsframework_tabs() {
		$counter = 0;
	 ...
	 */
	static function wdxxx_optionsframework_fields() {
		...
		foreach ( $options as $value ) {
			...
			// Uploader
			case "upload":
				$output .= wdxxx_Options_Framework_Media_Uploader::wdxxx_optionsframework_uploader( $value['id'], $val, null );
			...
			case 'typography':
				...
				$typography_options = array(
					'sizes' => wdxxx_of_recognized_font_sizes(),
					'faces' => wdxxx_of_recognized_font_faces(),
					'styles' => wdxxx_of_recognized_font_styles(),
					'color' => true
				);
			...
			case 'background':
				...
				$output .= wdxxx_Options_Framework_Media_Uploader::wdxxx_optionsframework_uploader( $value['id'], $background['image'], null, esc_attr( $option_name . '[' . $value['id'] . '][image]' ) );
				...
				$repeats = wdxxx_of_recognized_background_repeat();
				...
				$positions = wdxxx_of_recognized_background_position();
				...
				$attachments = wdxxx_of_recognized_background_attachment();
		...
		if ( wdxxx_Options_Framework_Interface::wdxxx_optionsframework_tabs() != '' ) {
			echo '</div>';
		}
	}
