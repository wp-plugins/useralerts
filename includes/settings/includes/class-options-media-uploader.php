...
class wdxxx_Options_Framework_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'wdxxx_optionsframework_media_scripts' ) );
	}
	...
	static function wdxxx_optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
	 ...
	 */
	function wdxxx_optionsframework_media_scripts( $hook ) {

		$menu = wdxxx_wdxxx_Options_Framework_Admin::wdxxx_menu_settings();
		...
		wp_register_script( 'of-media-uploader', plugin_dir_url( dirname(__FILE__) ) .'js/media-uploader.js', array( 'jquery' ), wdxxx_Options_Framework::VERSION );
