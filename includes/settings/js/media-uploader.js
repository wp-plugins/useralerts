jQuery(document).ready(function($){
	...
	function wdxxx_optionsframework_add_file(event, selector) {
		...
		if ( optionsframework_upload ) {
			...
			optionsframework_upload.on( 'select', function() {
				...
				optionsframework_selector.find('.remove-image, .remove-file').on('click', function() {
					wdxxx_optionsframework_remove_file( $(this).parents('.section') );
				});
			});
	...
	function wdxxx_optionsframework_remove_file(selector) {
		...
		selector.find('.upload-button').on('click', function(event) {
			wdxxx_optionsframework_add_file(event, $(this).parents('.section'));
		});
	}
